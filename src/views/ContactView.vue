<template>
  ...
  <header>
        ...
        <div class="left px-1 ml-14 text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          Contact &nbsp;

          <div class="h-[2px] w-32 bg-gray-500 md:w-96 aos-init aos-animate" data-aos="zoom-in-left"
