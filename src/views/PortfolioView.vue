      ...
      items: [
        {
          ...
          demo: 'https://aaronjoshuadev.netlify.app/'
        },
        {
          id: 2,
          name: 'BMI Calculator',
    ...
    <article data-page="about">
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-gray-400">
        ...
        <div>
          <div class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in">
            <div v-for="item in items" :key="item.id">
              <div
                class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-gray-50 md:gap-3 px-5 py-5 lg:px-5 ">
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-gray-200">
                    {{ item.tech }}
                  </div>
